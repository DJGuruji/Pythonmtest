...
const ProductForm = () => {
  ...
  return (
    <form
      ...
      className="bg-slate-100 space-y-6 p-8 max-w-2xl mx-auto bg-white shadow-lg rounded-lg"
      data-aos="fade-up"
    >
      <h1 className="text-lg text-center text-gray-700 ">Create Product</h1>
            ...
            <div key={optionIndex} className="flex items-center space-x-3">
              <div className="w-full">
                ...
                <input
                  ...
                  value={option}
                  onChange={(e) =>
                    handleOptionChange(e, variantIndex, optionIndex)
                  }
                  required
                  className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
              ...
              <button
                ...
                className="mt-8 px-4 py-2 text-sm text-white bg-red-500 rounded-lg hover:bg-red-600"
              >
                Remove Option
              </button>
            </div>
